...
function Movie() {
  ...
  const getData = async () => {
    ...
    if (categoryWord === null) {
      url = `http://loadbalancer-464990516.ap-northeast-2.elb.amazonaws.com/contents/category/movie/`; // url에 값을 할당
    } else {
      url = `http://loadbalancer-464990516.ap-northeast-2.elb.amazonaws.com/contents/category/movie/${categoryWord}`; // url에 값을 할당
    }
    try {
